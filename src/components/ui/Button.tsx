...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center font-semibold transition-all focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[#356611] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer';
  ...
  const variantClasses = {
    primary:
      'bg-[#A2E771] text-[#284E0D] hover:bg-[#83DF41] active:bg-[#6ecb2b] border border-transparent shadow-xs',
    secondary:
